...
VALUES (100.00, 'Cash', 'Dine-in', 'Pending', 'TEST123', 10.00);

-- Clean up test data
DELETE FROM orders WHERE coupon_code = 'TEST123';

-- If everything works, you should see the columns in this result:
